"""
Flask Emotion Detection Web Application

This module implements a web-based emotion detection service using Flask.
It analyzes text input and returns emotion scores along with the dominant emotion.
"""
...
def format_emotion_response(emotion_dict):
    """
    Converts an emotion dictionary into a formatted response string.
    """
    ...
    result = (f"For the given statement, the system response is {emotion_string}. "
